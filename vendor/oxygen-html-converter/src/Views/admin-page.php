    ...
    <div class="oxy-workspace">
        <div class="oxy-main-column">
            <section class="oxy-card oxy-step-card">
                ...
                <div class="oxy-source-grid">
                    <div class="oxy-source-field oxy-source-field-html">
                        <label for="oxy-html-input"><?php echo esc_html__('HTML', 'oxygen-html-converter'); ?></label>
                        <textarea id="oxy-html-input" placeholder="<?php echo esc_attr__('Paste your HTML here...', 'oxygen-html-converter'); ?>"></textarea>
                    </div>
                    <div class="oxy-source-field">
                        <label for="oxy-css-input"><?php echo esc_html__('CSS', 'oxygen-html-converter'); ?></label>
                        <textarea id="oxy-css-input" placeholder="<?php echo esc_attr__('Paste optional CSS here...', 'oxygen-html-converter'); ?>"></textarea>
                    </div>
                    <div class="oxy-source-field">
                        <label for="oxy-js-input"><?php echo esc_html__('JavaScript', 'oxygen-html-converter'); ?></label>
                        <textarea id="oxy-js-input" placeholder="<?php echo esc_attr__('Paste optional JavaScript here...', 'oxygen-html-converter'); ?>"></textarea>
                    </div>
                </div>
