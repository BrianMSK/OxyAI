    ...
    public function getContext(int $postId): array
    {
        ...
        return [
            ...
            'instructions' => [
                ...
                'For selector-only native styling, check selectorCompilerSupport first; flex wrapping, flex item growth/shrink, CSS grid, media queries, and pseudo states may need CSS fallback.',
