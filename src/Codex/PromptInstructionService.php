    ...
    public function getInstructions(): array
    {
        return [
            ...
            'rules' => [
                ...
                'Keep CSS Code for media queries, pseudo selectors, keyframes, complex selectors, responsive variants, and any unverified schema path.',
                ...
                'Do not hand-author complex EssentialElements such as tabs, accordions, menus, forms, sliders, icons, columns, or WooCommerce widgets unless list_oxygen_element_capabilities marks them as supported and you can satisfy their content contract exactly.',
            ...
            'mcpWorkflow' => [
                ...
                'Call list_oxygen_element_capabilities when you need to know which Oxygen/Breakdance element styles can be native versus class CSS. Use its breakdanceElementsForOxygen.autoMappedWhenPreferred and elements[].requiredContentPaths fields as the source of truth for EssentialElements.',
